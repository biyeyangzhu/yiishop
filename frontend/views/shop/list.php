    ...
    <div class="header w1210 bc mt15">
        ...
        <div class="logo w1210">
            <h1 class="fl"><a href=<?= \yii\helpers\Url::to(['shop/index']) ?>><img src="/images/logo.jpg"
                                                                                    style="width:300px " alt="京西商城"></a>
            </h1>
            <!-- 头部搜索 start -->
            <div class="search fl">
                <div class="search_form">
                    <div class="form_left fl"></div>
                    <form action=<?php \yii\helpers\Url::to(['shop/index'])?> name="serarch" method="get" class="fl">
                        <input type="text" class="txt" name="search" placeholder="请输入商品名" value=""  /><input type="submit" class="btn" value="搜索"/>
                    </form>
        ...
        <div class="nav w1210 bc mt10">
            ...
            <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
                ...
                <div class="cat_bd none">
                    ...
                    <?= \frontend\controllers\ShopController::Gategory_index() ?>
            ...
            <div class="goodslist mt10">
                <ul>
                    <?php foreach ($goods as $good): ?>
                        <li>
                            <dl>
                                <dt><a href=<?= \yii\helpers\Url::to(['shop/content','id'=>$good['id']]) ?>><img
                                                src=<?= $good['logo'] ?> alt=""/></a></dt>
