...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><img src="/images/logo.jpg" style="width: 300px" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href=<?=$goods['logo']?> class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src=<?=$goods['logo']?> alt="" style="width: 300px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$gall['path']?>',largeimage: '<?=$gall['path']?>'}"><img src=<?=$gall['path']?>></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
