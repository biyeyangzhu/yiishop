...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><img src="/images/logo.jpg" width="300px" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <tr>
                    ...
                    <td><a href=""><?=\frontend\models\Order::getLogo($value->id)?></a></td>
                    <td><?=$value->name?></td>
                    <td>￥<?=$value->delivery_price?>.00 <?=$value->delivery_name?></td>
