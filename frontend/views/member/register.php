...
<div class="header w990 bc mt15">
    <div class="logo w990">
        <h2 class="fl"><a href="index.html"><img src="/images/logo.jpg" alt="金叫唤商城"></a></h2>
    </div>
</div>
<!-- 页面头部 end -->
...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action=<?=\yii\helpers\Url::to(['member/register'])?> method="post" id="register_form">
                <ul>
                    <li>
                        <label for="">用户名：</label>
...
// 在键盘按下并释放及提交后验证提交表单
        $("#register_form").validate({
            ...
            messages: {
                username: {
                    required: "请输入用户名",
                    minlength: "用户名必需由3-20个字符组成",
                    maxlength: "用户名必需由3-20个字符组成",
                    remote:"用户名已存在",
                },
                password: {
                    required: "请输入密码",
                    minlength: "密码长度不能小于 6 个字符",
                    maxlength: "密码长度不能大于20 个字符",
                },
                confirm_password: {
                    required: "请输入密码",
                    minlength: "密码长度不能小于 6 个字符",
